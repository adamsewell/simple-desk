 ...
 **/
function sd_menuoptions ($list,$selected=null,$values=false,$extend=false) {
	...
	foreach ($list as $value => $text) {
		...
		if (is_array($text)) {
			...
			$_[] = sd_menuoptions($text,$selected,$values);
			$_[] = '</optgroup>';
			continue;
		}
